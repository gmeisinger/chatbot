...
class InputProcessor:
    ...
    def process(self):
        ...
        global greetings, goodbyes, questions, death_keywords, mort_rate_keywords, case_keywords, gender_keywords, comp_keywords, age_keywords, recover_words, states, Country, graph_words, glob_keywords, rel_time_keywords, months
